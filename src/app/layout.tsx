...
export const metadata: Metadata = {
  title: {
    default: "My Lantern | Child Consultation Centre in Wandoor, Kerala",
    template: "%s | My Lantern",
  },
  ...
  keywords: [
    ...
    "Career Counselling", "Wandoor", "Kerala", "My Lantern"
  ],
  authors: [{ name: "My Lantern" }],
  creator: "My Lantern",
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://www.mylantern.in",
    title: "My Lantern | Child Consultation Centre in Wandoor, Kerala",
    description: "Expert guidance for every child's unique journey. A premium child consultation centre in Wandoor, Kerala.",
    siteName: "My Lantern",
  },
  twitter: {
    card: "summary_large_image",
    title: "My Lantern | Child Consultation Centre",
    description: "Expert guidance for every child's unique journey. A premium child consultation centre in Wandoor, Kerala.",
  },
  robots: {
    index: true,
